                        ...
                        <div className="row">
                                            ...
                                            <div className="row g-3">
                                                ...
                                                <div className="col-xxl-12 col-12 mb-3">
                                                    <div className="d-flex align-items-center">
                                                        <img className="me-3 rounded-circle me-0 me-sm-3" src="./images/avatar/3.jpg" width={55} height={55} alt="" />
                                                        <div className="media-body">
                                                            <h4 className="mb-0">Hafsa Humaira</h4>
                            ...
                            <div className="col-xxl-12">
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        <form method="post" name="myform" className="personal_validate" noValidate="novalidate">
                                            <div className="row g-4">
                                                <div className="col-xxl-6 col-xl-6 col-lg-6">
                                                    <label className="form-label">Full Name</label>
                                                    <input type="text" className="form-control" placeholder="Hafsa Humaira" name="fullname" />
                                                </div>
                                                <div className="col-xxl-6 col-xl-6 col-lg-6">
                                                ...
                                                <div className="col-12">
                                                    <button className="btn btn-primary pl-5 pr-5">Save</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
